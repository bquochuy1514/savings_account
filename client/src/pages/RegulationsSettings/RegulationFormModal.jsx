...
export default function RegulationFormModal({
    ...
    // Thêm state lưu bản sao gốc để so sánh
        ...
        if (isOpen) {
            ...
            if (editingType) {
                defaultData = {
                    ...
                    minWithdrawDays:
                        editingType.minWithdrawDays?.toString() || '',
                    minInitDeposit:
                        editingType.minInitDeposit?.toString() || '',
            ...
            // Cập nhật cả 2 state cùng một lúc
    ...
    // KIỂM TRA SỰ THAY ĐỔI (isDirty logic)
    const isDirty = useMemo(() => {
        if (!initialFormData) return false;
        // Kiểm tra xem có field nào khác với bản gốc không
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const withdrawDays =
                term === 0 ? Number(formData.minWithdrawDays) : 0;

            const payload = {
                name: String(formData.name).trim(),
                termMonths: term,
                interestRate: parseFloat(
                    String(formData.interestRate).replace(',', '.'),
                ),
            ...
            <div className="bg-white rounded-3xl w-full max-w-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-0.5">
                                Thiết lập các tham số cho loại sổ tiết kiệm
                            </p>
                        </div>
                    </div>
                    <button
                ...
                <form onSubmit={handleSubmit} className="p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6 mb-8">
                        ...
                        <div className="space-y-5">
                            ...
                            <Input
                                ...
                                placeholder="VD: Không kỳ hạn, 3 tháng..."
                        ...
                        <div className="space-y-5">
                            ...
                            <Input
                                ...
                                error={errors.minInitDeposit}
                            />
                            <Input
                                label={
                                    <>
                                        Gửi thêm tối thiểu (VNĐ){' '}
                                        <span className="text-red-400">*</span>
                                    </>
                                }
                                name="minAddDeposit"
                        ...
                        <div className="col-span-full pt-4 mt-2 border-t border-gray-100 flex justify-between items-center bg-gray-50/50 p-4 rounded-2xl">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-0.5">
                                    Xác định xem khách hàng có thể mở loại sổ
                                    này không.
                                </p>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                                ...
                                <span
                                    className={`ml-3 text-sm font-bold ${formData.isActive ? 'text-blue-600' : 'text-gray-400'}`}
                                >
                                    {formData.isActive
                                        ? 'ĐANG BẬT'
                                        : 'ĐANG TẮT'}
                    ...
                    <div className="flex items-center justify-end gap-3 pt-6 border-t border-gray-100">
                        ...
                        {/* ĐÃ SỬA: Chặn nút bằng điều kiện !isDirty */}
                        <Button
                            type="submit"
                            isLoading={isLoading}
