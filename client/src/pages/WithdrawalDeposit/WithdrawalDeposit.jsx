...
export default function WithdrawalDeposit() {
  ...
  return (
    <div className="p-6"> {/* Container chính chỉ có padding, KHÔNG giới hạn max-w và mx-auto */}
      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden p-6 mt-6 w-full shadow-sm">
        <form onSubmit={handleSubmit} className="space-y-5"> {/* KHÔNG giới hạn max-w-4xl ở form để input trải rộng */}
